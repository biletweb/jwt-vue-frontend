    ...
    <table class="w-full text-left text-sm text-gray-500">
      ...
      <tbody v-if="users.length > 0">
        ...
        >
          ...
          <td v-if="user.verify_email" class="truncate px-6 py-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke-width="1.5"
              stroke="currentColor"
              class="h-6 w-6 text-red-500 opacity-60"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <td v-else class="truncate px-6 py-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke-width="1.5"
              stroke="currentColor"
              class="h-6 w-6 text-green-500 opacity-60"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
